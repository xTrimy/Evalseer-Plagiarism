export const LanguageIcon = [
  { icon: { name: 'git' }, ids: ['git', 'git-commit', 'git-rebase', 'gitignore'] },
  ...
  {
    icon: { name: 'settings' },
    ids: ['makefile', 'toml', 'ini', 'properties','config'],
  },
  ...
  { icon: { name: 'python' }, ids: ['python','py'] },
  { icon: { name: 'javascript' }, ids: ['javascript','js'] },
  { icon: { name: 'typescript' }, ids: ['typescript','ts'] },
  ...
  { icon: { name: 'markdown' }, ids: ['markdown','md'] },
