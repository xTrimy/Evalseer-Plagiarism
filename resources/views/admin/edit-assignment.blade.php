...
<main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            @if($errors->any())
                ...
                {!! implode('', $errors->all('<div class="bg-red-100 rounded-lg py-5 px-6 mb-3 text-base text-red-700 inline-flex items-center w-full" role="alert">
            ...
            @endif
              ...
              <label class="block text-sm mt-2">
                ...
                <input
                value="{{ date('Y-m-d\TH:i', strtotime($assignment->start_time)) }}"
                    type="datetime-local"
                    name="start_time"
                    required
                  class="block w-full mt-1 text-sm border dark:border-gray-600 dark:bg-gray-700 focus:border-orange-400 focus:outline-none focus:shadow-outline-orange dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              ...
              <label class="block text-sm mt-2">
                ...
                <input
                id="end_time"
                value="{{ date('Y-m-d\TH:i', strtotime($assignment->end_time)) }}"
                    type="datetime-local"
                    name="end_time"
                    required
                  class="block w-full mt-1 text-sm border dark:border-gray-600 dark:bg-gray-700 focus:border-orange-400 focus:outline-none focus:shadow-outline-orange dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              ...
              <label class="block text-sm mt-2">
                ...
                <input
                id="late_time"
                value="{{ date('Y-m-d\TH:i', strtotime($assignment->late_time)) }}"
                    type="datetime-local"
                    name="late_time"
                    required
                  class="block w-full mt-1 text-sm border dark:border-gray-600 dark:bg-gray-700 focus:border-orange-400 focus:outline-none focus:shadow-outline-orange dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              ...
              <label class="block text-sm mt-2">
                ...
                required
                  ...
                  class="block w-full mt-1 text-sm border dark:border-gray-600 dark:bg-gray-700 focus:border-orange-400 focus:outline-none focus:shadow-outline-orange dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  name="course_id">
                  <option value="{{ $coursesSel->id }}" selected>{{ $coursesSel->name }}</option>
              ...
              <button type="submit" class=" mb-10 table items-center mt-4 m-auto justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-orange-600 border border-transparent rounded-lg active:bg-orange-600 hover:bg-orange-700 focus:outline-none focus:shadow-outline-orange">
              Save Assignment
            ...
            <div class="flex justify-between mt-8 items-center">
              ...
              >
              <a
              href="{{ route('dashboard.add_question',['id'=>$assignment->id]) }}"
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  @endphp
                      ...
                      <td class="px-4 py-3 text-center w-1/3" title="{{ $question->description }}">
                        {{ Str::limit($question->description, 60, $end='...') }}
                      </td>
                      <td class="px-4 py-3">
                        {{ $question->grade }}
                      </td>
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm justify-center">
                          ...
                          <button
                            type="button"
                            class="transition duration-150 ease-in-out flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-orange-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete"
                          ...
                          <div class="modal fade fixed top-1/2 left-1/3 hidden w-2/5 h-full m-auto outline-none overflow-x-hidden overflow-y-auto justify-center z-50 px-3"
                          id="modal{{$i}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog relative w-auto pointer-events-none">
                            <div
                              class="modal-content border-none shadow-2xl relative flex flex-col w-full pointer-events-auto m-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                              <div
                              ...
                              <div class="modal-body relative p-4">
                                Are you sure you want to delete <span class="font-semibold">{{ $question->name }}</span> ?
                              </div>
                              <div
